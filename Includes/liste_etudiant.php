...
<table border="3">
	...
	<tr>
		...
		<td><?php $id=$donnee['id']; echo "<a href='index.php?pg=Update_etudiant&id=$id'>Update_etudiant</a>"; ?></td>
		<td><?php $id=$donnee['id']; echo "<a href='index.php?pg=Supprime_etudiant&id=$id'>Supprime_etudiant</a>"; ?></td>
	</tr>
